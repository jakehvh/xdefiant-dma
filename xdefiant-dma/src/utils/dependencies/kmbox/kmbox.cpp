...
int kmNet_init( char* ip, char* port, char* mac )
{
	...
	DWORD time = 1000;
	setsockopt( sockClientfd, SOL_SOCKET, SO_SNDTIMEO, ( char* )&time, sizeof( time ) );
	setsockopt( sockClientfd, SOL_SOCKET, SO_RCVTIMEO, ( char* )&time, sizeof( time ) );
